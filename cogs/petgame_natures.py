...
_ORDER = ['fire', 'water', 'nature', 'earth', 'storm', 'ice', 'shadow', 'crystal', 'steel', 'light']

_MATRIX = [
    # foc   apa   nat   pam   fur   ghe   umb   cri   met   lum
    [1.0,  0.5,  2.0,  0.5,  0.5,  2.0,  2.0,  1.0,  2.0,  1.0],  # fire
    [2.0,  1.0,  0.5,  2.0,  1.0,  1.0,  1.0,  2.0,  1.0,  1.0],  # water
    [0.5,  2.0,  1.0,  2.0,  0.5,  2.0,  0.5,  2.0,  0.5,  1.0],  # nature
    [2.0,  0.5,  0.5,  1.0,  2.0,  0.5,  2.0,  1.0,  2.0,  1.0],  # earth
    [1.0,  2.0,  2.0,  0.0,  1.0,  0.5,  2.0,  0.5,  2.0,  1.0],  # storm
    [0.5,  1.0,  2.0,  0.5,  0.5,  1.0,  2.0,  2.0,  0.5,  1.0],  # ice
    [2.0,  1.0,  0.5,  0.5,  2.0,  0.5,  1.0,  2.0,  1.0,  0.5],  # shadow
    [0.5,  0.5,  0.5,  1.0,  2.0,  2.0,  2.0,  1.0,  1.0,  2.0],  # crystal
    [0.5,  1.0,  2.0,  0.5,  0.5,  2.0,  1.0,  2.0,  1.0,  1.0],  # steel
    [1.0,  1.0,  1.0,  0.5,  1.0,  2.0,  2.0,  2.0,  0.5,  1.0],  # light
]
